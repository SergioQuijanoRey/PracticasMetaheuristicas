...
// TODO -- usar el metodo run_from_init_sol para no copiar demasiado codigo
...
/// Lanza la busqueda local, pero en vez de con una solucion inicial aleatoria, se da el valor de
/// la solucion inicial
